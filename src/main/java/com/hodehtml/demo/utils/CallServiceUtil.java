...
public class CallServiceUtil {
	...
	private static final Log log = LogFactory.getLog(CallServiceUtil.class);
	...
	public static String sendGet(String url, String param) {
		...
		// 使用finally块来关闭输入流
			...
			try {
				...
				log.error(CommonUtils.getTraceInfo()+" url:"+url+" param:"+param+"\t"+StringUtils.nullToStrTrim(e2.getMessage()));
			}
		}
		return result;
	}
	...
	public static String sendPost(String url, String param) throws Exception {
		...
		try {
			...
			log.error(CommonUtils.getTraceInfo()+" url:"+url+" param:"+param+"\t"+StringUtils.nullToStrTrim(e.getMessage()));
		...
		// 使用finally块来关闭输出流、输入流
			...
			try {
				...
				log.error(CommonUtils.getTraceInfo()+" url:"+url+" param:"+param+"\t"+StringUtils.nullToStrTrim(ex.getMessage()));
			}
		}
		return result;
	}
